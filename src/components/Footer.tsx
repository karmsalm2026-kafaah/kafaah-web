...
export function Footer() {
  ...
  return (
    <footer dir={rtl ? "rtl" : "ltr"} className="relative bg-gradient-to-b from-navy-dark to-navy-deep overflow-hidden border-t border-white/[0.08]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-row lg:justify-between items-start gap-8 mb-8">
          ...
          <div className="w-full lg:max-w-[340px] flex flex-col items-center lg:items-start text-center lg:text-justify">
            ...
            <div className="grid grid-cols-2 gap-2.5 mb-4 w-full text-start">
              {/* Address Card */}
              <div className="relative group/card bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] hover:border-gold/35 hover:bg-navy-card-hover/60 rounded-sm p-3.5 transition-all duration-300 flex flex-col gap-2 overflow-hidden shadow-[0_12px_36px_rgba(0,0,0,0.4)]">
            ...
            <div className="pt-1.5 flex flex-col items-center lg:items-start gap-2 w-full text-center lg:text-start">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-2">
                <a href="https://wa.me/201018081191" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-9 h-9 rounded-sm bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] flex items-center justify-center hover:border-[#25D366] hover:bg-[#25D366]/15 hover:text-[#25D366] hover:-translate-y-1 hover:scale-105 backdrop-blur-sm text-silver transition-all duration-300 shadow-[0_8px_24px_rgba(0,0,0,0.3)]">
                ...
                <a href="https://www.facebook.com/profile.php?id=61591826631868" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 rounded-sm bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] flex items-center justify-center hover:border-[#1877F2] hover:bg-[#1877F2]/15 hover:text-[#1877F2] hover:-translate-y-1 hover:scale-105 backdrop-blur-sm text-silver transition-all duration-300 shadow-[0_8px_24px_rgba(0,0,0,0.3)]">
                ...
                <a href="https://www.linkedin.com/company/133434076" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-9 h-9 rounded-sm bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] flex items-center justify-center hover:border-[#0077B5] hover:bg-[#0077B5]/15 hover:text-[#0077B5] hover:-translate-y-1 hover:scale-105 backdrop-blur-sm text-silver transition-all duration-300 shadow-[0_8px_24px_rgba(0,0,0,0.3)]">
                ...
                <a href="#" aria-label="X" className="w-9 h-9 rounded-sm bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] flex items-center justify-center hover:border-gold hover:bg-gold/15 hover:text-gold hover:-translate-y-1 hover:scale-105 backdrop-blur-sm text-silver transition-all duration-300 shadow-[0_8px_24px_rgba(0,0,0,0.3)]">
          ...
          <div className="w-full lg:max-w-[260px] flex flex-col items-start text-start">
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-col gap-1.5 mb-2.5 w-full">
              <Link
                href="/services/"
                className="flex items-center justify-center h-8 text-[9px] sm:text-[10px] font-bold font-[family-name:var(--font-ui)] bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] hover:border-gold/35 hover:bg-navy-card-hover/60 text-white/85 hover:text-gold rounded-sm transition-all duration-300 text-center px-1 sm:px-4 truncate shadow-[0_8px_24px_rgba(0,0,0,0.3)]"
              >
            ...
            <div className="grid grid-cols-3 gap-1.5 mb-2.5 w-full">
              {[
                ...
                <Link
                  ...
                  className="flex items-center justify-center h-8 text-[10px] font-bold font-[family-name:var(--font-ui)] bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] hover:border-gold/35 hover:bg-navy-card-hover/60 text-white/85 hover:text-gold rounded-sm transition-all duration-300 shadow-[0_8px_24px_rgba(0,0,0,0.3)]"
                >
                  {t.formula}
                </Link>
              ))}
          ...
          <div className="w-full lg:max-w-[260px] flex flex-col items-start text-start">
            ...
            <div className="grid grid-cols-2 gap-1.5 mb-3.5 w-full">
              {companyLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="flex items-center gap-2 px-3 h-8 text-[10px] font-bold font-[family-name:var(--font-ui)] bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] hover:border-gold/35 hover:bg-navy-card-hover/60 text-white/85 hover:text-gold rounded-sm transition-all duration-300 shadow-[0_8px_24px_rgba(0,0,0,0.3)]"
                >
            ...
            <div className="bg-gradient-to-b from-[#1b2b3d]/60 to-[#121f2d]/60 border border-white/[0.08] hover:border-gold/35 hover:bg-navy-card-hover/60 rounded-md p-3.5 transition-all duration-300 flex flex-col gap-2.5 w-full mb-3.5 shadow-[0_12px_36px_rgba(0,0,0,0.4)]">
