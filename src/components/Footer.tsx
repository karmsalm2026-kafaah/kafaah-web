          ...
          <div className="w-full max-w-[340px] flex flex-col items-start text-justify">
            ...
            <div className="pt-1.5 flex flex-col items-start gap-2 w-full text-start">
              ...
              <div className="flex items-center justify-start gap-2">
                ...
                <a href="#" aria-label="Twitter" className="w-9 h-9 rounded-sm bg-white/[0.03] border border-white/[0.08] flex items-center justify-center hover:border-gold hover:bg-gold/10 hover:text-gold hover:-translate-y-1 hover:scale-105 backdrop-blur-sm text-silver transition-all duration-300 shadow-md">
