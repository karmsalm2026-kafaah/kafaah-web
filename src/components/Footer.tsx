          ...
          <div className="w-full lg:max-w-[340px] flex flex-col items-start text-justify">
            ...
            <div className="pt-1.5 flex flex-col items-start gap-2 w-full text-start">
              ...
              <div className="flex items-center justify-start gap-2">
                ...
                <a href="https://www.facebook.com/profile.php?id=61591826631868" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 rounded-sm bg-white/[0.03] border border-white/[0.08] flex items-center justify-center hover:border-[#1877F2] hover:bg-[#1877F2]/10 hover:text-[#1877F2] hover:-translate-y-1 hover:scale-105 backdrop-blur-sm text-silver transition-all duration-300 shadow-md">
                ...
                <a href="https://www.linkedin.com/company/133434076" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-9 h-9 rounded-sm bg-white/[0.03] border border-white/[0.08] flex items-center justify-center hover:border-[#0077B5] hover:bg-[#0077B5]/10 hover:text-[#0077B5] hover:-translate-y-1 hover:scale-105 backdrop-blur-sm text-silver transition-all duration-300 shadow-md">
