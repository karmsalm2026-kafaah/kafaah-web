          ...
          <div className="lg:col-span-4 flex flex-col">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <a href="https://wa.me/201018081191" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-sm bg-white/[0.03] border border-white/[0.08] flex items-center justify-center hover:border-[#25D366] hover:bg-[#25D366]/10 hover:text-[#25D366] text-silver transition-all duration-300">
                ...
                <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-sm bg-white/[0.03] border border-white/[0.08] flex items-center justify-center hover:border-[#0077B5] hover:bg-[#0077B5]/10 hover:text-[#0077B5] text-silver transition-all duration-300">
