      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center container mx-auto px-3 sm:px-6 lg:px-8 pt-20 pb-4 sm:pt-24 sm:pb-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 w-full">
          ...
          <StaggerChildren className="relative w-full lg:w-[65%] flex flex-col items-center lg:items-start text-center lg:text-start justify-center max-w-[500px] sm:max-w-[580px] lg:max-w-[620px] mx-auto lg:mx-0">
            ...
            <RevealItem className="w-full">
              <div className="grid grid-cols-2 gap-1.5 xs:gap-2 sm:gap-4 mt-2 w-full max-w-[280px] xs:max-w-[310px] sm:max-w-none mx-auto lg:mx-0">
                <Link
                  href={primary.href}
                  className={`group btn-premium-gold !gap-1.5 sm:!gap-2.5 px-1 xs:px-2 py-[5px] sm:py-3 ${locale !== "en" ? getFontClass(locale) + " text-[11px] xs:text-[12px] sm:text-[14px] font-bold" : "font-[family-name:var(--font-ui)] text-[8.5px] xs:text-[9.5px] sm:text-[12px] font-bold tracking-[0.04em] xs:tracking-[0.08em] sm:tracking-[0.15em] uppercase"} w-full justify-center`}
                >
