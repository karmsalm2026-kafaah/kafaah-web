  ...
  return (
    <section dir={rtl ? "rtl" : "ltr"} className="relative min-h-[95vh] md:h-[90dvh] flex flex-col overflow-hidden bg-navy-deep">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className={`absolute inset-0 ${rtl ? "max-md:bg-gradient-to-b md:bg-gradient-to-l" : "max-md:bg-gradient-to-b md:bg-gradient-to-r"} max-md:from-navy-deep/30 from-navy-deep/55 md:from-navy-deep/65 max-md:via-navy-deep/20 via-navy-deep/40 md:via-navy-deep/45 sm:via-navy-deep/30 to-transparent`} />
