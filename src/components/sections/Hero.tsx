...
export function HeroSection({ content }: Props) {
  ...
  return (
    <section dir={rtl ? "rtl" : "ltr"} className="relative min-h-[95vh] md:h-[90dvh] flex flex-col overflow-hidden bg-navy-deep">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className={`absolute inset-0 ${rtl ? "max-md:bg-gradient-to-t md:bg-gradient-to-l" : "max-md:bg-gradient-to-t md:bg-gradient-to-r"} max-md:from-navy-deep/30 from-navy-deep/55 md:from-navy-deep/65 max-md:via-navy-deep/20 via-navy-deep/40 md:via-navy-deep/45 sm:via-navy-deep/30 to-transparent`} />
        <div className="absolute inset-0 bg-gradient-to-b from-navy-deep/15 sm:via-transparent via-transparent to-navy-deep/40" />
        {/* Mobile only dark overlay for high text contrast - lightened for mobile */}
        <div className="absolute inset-0 bg-navy-deep/35 max-md:bg-gradient-to-b max-md:from-navy-deep/45 max-md:via-navy-deep/30 max-md:to-navy-deep/50 md:hidden z-1 pointer-events-none" />
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center container mx-auto px-3 sm:px-6 lg:px-8 pt-[calc(5rem+20vh)] pb-4 sm:pt-24 sm:pb-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 w-full">
          ...
          <StaggerChildren className="relative w-full lg:w-[65%] flex flex-col items-center lg:items-start text-center lg:text-start justify-center max-w-[500px] sm:max-w-[580px] lg:max-w-[620px] mx-auto lg:mx-0">
            ...
            <RevealItem className="w-full">
              <p className={`${locale !== "en" ? getFontClass(locale) : ""} text-[12.5px] xs:text-[13.5px] sm:text-base text-white/90 md:text-silver/85 w-[100%] sm:w-full leading-relaxed mb-4 sm:mb-8 font-normal text-center lg:text-start mx-auto lg:mx-0`}>
