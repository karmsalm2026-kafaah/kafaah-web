...
export function WhoWeAreClient() {
  ...
  return (
    <div dir={rtl ? "rtl" : "ltr"} className="bg-navy-dark min-h-screen relative overflow-hidden">
              ...
              <div className="lg:col-span-5">
                <StaggerChildren className="grid grid-cols-1 sm:grid-cols-2 gap-4" staggerDelay={0.08}>
                  {dict.founderStats[locale].map((stat, idx) => (
                    <RevealItem key={idx}>
                      <div className="relative group bg-navy-card/20 border border-white/[0.08] hover:border-gold/30 p-3.5 xs:p-5 rounded-sm transition-all duration-300 flex flex-col justify-between min-h-[120px] backdrop-blur-sm overflow-hidden select-none cursor-default">
                        {/* Corner gold pulse */}
          ...
          <div className="space-y-10">
            ...
            <StaggerChildren className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5" staggerDelay={0.06}>
              {dict.diffFeatures[locale].map((feat, idx) => (
                <RevealItem key={idx}>
                  <div className="relative group bg-navy-card/20 border border-white/[0.08] hover:border-gold/30 border-s-3 hover:border-s-gold/80 p-3.5 xs:p-5 sm:p-6 rounded-sm transition-all duration-300 flex flex-col gap-3 backdrop-blur-sm h-full select-none cursor-default">
                    {/* Glowing highlight */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-6">
                <StaggerChildren className="grid grid-cols-1 gap-5" staggerDelay={0.1}>
                  <RevealItem>
                    <div className="relative group bg-navy-card/25 border border-white/[0.08] hover:border-gold/30 p-3.5 xs:p-5 sm:p-6 rounded-sm transition-all duration-300 flex flex-col gap-2 backdrop-blur-sm border-s-3 border-s-sky-400/60 hover:border-s-sky-400 select-none cursor-default">
                  ...
                  <RevealItem>
                    <div className="relative group bg-navy-card/25 border border-white/[0.08] hover:border-gold/30 p-3.5 xs:p-5 sm:p-6 rounded-sm transition-all duration-300 flex flex-col gap-2 backdrop-blur-sm border-s-3 border-s-emerald-400/60 hover:border-s-emerald-400 select-none cursor-default">
      ...
      {/* ── OUR DOMAIN SECTION ── */}
      <section className="relative py-14 lg:py-28 border-b border-white/[0.04]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-10">
            ...
            <StaggerChildren className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.06}>
              {dict.domainCards[locale].map((tech, idx) => {
                ...
                return (
                  <RevealItem key={idx}>
                    <div className="relative group bg-navy-card/25 border border-white/[0.08] hover:border-gold/30 border-s-3 border-s-gold/75 hover:border-s-gold p-3.5 xs:p-5 sm:p-6 rounded-sm transition-all duration-300 flex flex-col justify-between min-h-[170px] backdrop-blur-sm h-full select-none cursor-default">
